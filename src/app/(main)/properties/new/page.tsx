...
export default function NewPropertyPage() {
  ...
  // Fetch parent locations for the dropdown
  ...
  const createMutation = useMutation({
    mutationFn: (data: LocationFormData) => {
      ...
      return locationsApi.create(payload as Parameters<typeof locationsApi.create>[0]);
    },
    onSuccess: (response) => {
  ...
  const parentLocations = locationsData?.data || [];
